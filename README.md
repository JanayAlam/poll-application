# Janay Poll
This is a poll application written in nodejs with the express microframework. The documentation of this REST API generated by swagger and open API. This application is using mongoodb as database and mongoose as ODM.
<br>
